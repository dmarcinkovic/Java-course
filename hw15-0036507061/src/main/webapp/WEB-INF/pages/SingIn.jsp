...
<body>
	...
	<div>
		 <div>
		  <span class="formLabel">Password</span><input type="password" name="passwordHash" value='<c:out value="${zapis.passwordHash}"/>' size="50">
		 </div>
	...
	<div>
		 ...
		 <div class="greska"><c:out value="${zapis.dohvatiPogresku('nickAlreadyExists')}"/></div>
		 </c:if>
	</div>
	
	<div class="formControls">
		  <span class="formLabel">&nbsp;</span>
		  <input type="submit" name="metoda" value="SIGN IN">
		</div>
