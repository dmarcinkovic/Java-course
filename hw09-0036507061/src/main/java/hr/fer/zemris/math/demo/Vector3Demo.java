...
/**
 * Example to test if Vector3 class works properly.
 * 
 * @author david
 *
 */
public class Vector3Demo {
	...
	/**
	 * Method invoked when running the program. This method is used to test that all
	 * method from Vector3 class are implemented correctly.
	 * 
