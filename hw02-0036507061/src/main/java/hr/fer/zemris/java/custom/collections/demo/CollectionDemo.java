...
/**
 * Class to represent how ArrayIndexedCollection and LinkedListIndexedCollection
 * works.
 * 
 * @author david
 *
...
public class CollectionDemo {
	...
	/**
	 * Method invoked when starting the program. In this program it is used to test
	 * classes ArrayIndexedCollection and LinkedListIndexedCollection.
	 * 
	 * @param args Argument given in command line. In this example they are not
	 *             used.
	 */
