...
public interface Environment {
	...
	/**
	 * Allows commands to share/ remember certain data.
	 * 
	 * @param key Key which is associated with the shared data.
	 * @return Shared data.
	 */
	Object getSharedData(String key);

	/**
	 * Allows command to share / remember certain data.
	 * 
	 * @param key   Key which will be associated with the shared data.
